    ...
    >
      ...
      <div className="sticky top-16 bg-darkBg border-b border-neonPurple/20 pb-4 z-10">
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <button className="neon-button-green flex items-center space-x-2 px-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        {currentEvents.map((event, index) => (
          <motion.div
            ...
            className="neon-card-green p-6 cursor-pointer hover:shadow-neon-green"
      ...
      {totalPages > 1 && (
        <div className="flex justify-center items-center space-x-2 pt-8">
          <button
            ...
            className="neon-button-green px-4 py-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Previous
          </button>
